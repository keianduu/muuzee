...
type WorkCandidateRow = { id: string; artist_id: string | null; matched_work_id: string | null; title: string; year_text: string | null; source_artist_name: string | null; source_venue_name: string | null; matched_venue_id: string | null; holding_type: string | null; presentation_type: string | null; presentation_status: string | null; match_status: string; representative_reason: string; source_url: string | null; data_sources?: { name?: string; key?: string } | Array<{ name?: string; key?: string }> };
