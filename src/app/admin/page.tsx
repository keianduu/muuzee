...
export default async function AdminDashboard() {
  ...
  return <>
    ...
    <section className="card"><h2>Master Admin v1</h2><p className="muted">Venue / Artist / WorkをManual、CSV、利用可能な外部Sourceから管理します。自動処理はCandidateまたはDraftを作り、人の確認前に公開しません。</p><div className="actions"><Link className="button" href="/admin/venues">Venues</Link><Link className="button secondary" href="/admin/artists">Artists</Link><Link className="button secondary" href="/admin/works">Works</Link><Link className="button secondary" href="/admin/imports">Exhibition Import</Link></div></section>
