...
path = Path("AGENTS.md")
text = path.read_text()
marker = "Within the prototype, `prototype/design-guide.html` is the source of truth for the **current prototype Global Design Rules**. It may still be exploratory and does not by itself promote a rule into an approved product specification.\n"
section = """
...
"""
if "### Generated implementation documentation" in text:
    raise SystemExit("Generated implementation documentation section already exists")
if marker not in text:
    raise SystemExit("Source of Truth insertion marker not found")
