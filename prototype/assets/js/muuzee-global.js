...
(() => {
  ...
  async function initDiscoverySurfaces(){
    ...
    await loadSharedScript("muuzee-surface-fixtures.js?v=20260919-order658-01",() => Boolean(window.MuuzeeSurfaceFixturesReady));
    ...
    await loadSharedScript("muuzee-surface-runtime.js?v=20260919-order658-01",() => Boolean(window.MuuzeeSurfaceRuntimeReady));
  }
